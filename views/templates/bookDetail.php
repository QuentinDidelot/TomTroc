 <section class="bookDetail">
        <div class="book_detail_left">
            <img src="img\books\harry_potter_5.jpg" alt="couverture du livre choisi">
        </div>
